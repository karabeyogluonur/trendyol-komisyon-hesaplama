    ...
    public class TrendyolOrderProfile : Profile
    {
        public TrendyolOrderProfile()
        {
            ...
            CreateMap<TrendyolOrderContent, MarketplaceOrderDto>()
                ...
                .ForMember(dest => dest.MarketplaceShipmentId, opt => opt.MapFrom(src => src.ShipmentPackageId.ToString()))
                ...
                .ForMember(dest => dest.CargoDeci, opt => opt.MapFrom(src => src.CargoDeci))
